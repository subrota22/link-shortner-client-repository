...
const ResetPassword = () => {
  ...
  return (
    <>
      ...
      <div className="my-5">
          <div style={{ width: "30%" }} className="bg-success text-white shadow-md text-xl text-center  m-auto uppercase fw-bolder py-3"> Reset password  </div>
          <form autoComplete='off' style={{ width: "30%" }} className='was-validated shadow-md bg-dark  w mx-auto rounded-2 p-3 text-white' onSubmit={handleSubmit}>
            <div className="my-5">
