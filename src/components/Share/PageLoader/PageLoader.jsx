...
const PageLoader = () => {
    return (
        <>
                ...
                <div role="status" class="h-screen p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700" style={{width:"100%"}}>
                    <div class="flex items-center justify-center  h-48 mb-14 bg-gray-300 rounded dark:bg-gray-700">
